...
export default function PresonalDetailsScreen({navigation}) {
    ...
    >
        ...
        >
         <View >
            <Text style={{paddingLeft: 10, color: "#666666"}}>{datestr}</Text>
