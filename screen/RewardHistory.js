            ...
            >
              ...
              >
                <Image
                  ...
                  source={require('../assets/SO_Survey.png')}
                />
              </View>
              <View>
                <Text
                ...
                >
                  Sorry, you have no reward history.
                </Text>
              </View>
            </View>
          )}
          {comments &&
            comments.map((ele, val) => {
              return (
                <View style={styles.products} key={val}>
                  <View
                    style={[styles.center, { width: '50%', paddingTop: 5 }]}
                  >
                    <View style={{ alignItems: 'center', marginTop: 0 }}>
                      <Image
                        style={[styles.stretch]}
                  ...
                  <View style={styles.center}>
                    {/* <Text style={{textAlign: 'center', fontWeight: 'bold'}}>{ele.mode_name}</Text> */}
                    <Text style={[styles.reward_his_text, {}]}>
                      <Text style={{ fontWeight: '600' }}>Redeem Points</Text> :{' '}
                      {ele.redeem_points}
                    </Text>
                    <Text style={[styles.reward_his_text, {}]}>
                      <Text style={{ fontWeight: '600' }}>Voucher worth</Text> :{' '}
                      {ele.currency_sign} {ele.worth}
                    </Text>
                    <Text style={[styles.reward_his_text, {}]}>
                      <Text style={{ fontWeight: '600' }}>Trans ID</Text> :{' '}
                      {ele.transaction_id}
                    </Text>
                    <Text style={[styles.reward_his_text, {}]}>
