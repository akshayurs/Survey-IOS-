    ...
    if(data_arr == null){
        ...
        >
            { renderProgressBar() }
            {
                ...
                <>
                    <Text style={{color: '#000000', marginTop:10,  fontSize:normalize(18), fontWeight: 'bold'}}>{data_arr[ques].Question.question_title}</Text> 
                </>  
                :
        ...
        
            {
                ...
                <Text style={{ marginTop:10,  fontSize:normalize(11), color: '#00a4de',fontStyle: 'italic'}}>Please select all that apply</Text>
                :
                <Text style={{ marginTop:10,  fontSize:normalize(11), color: '#00a4de',fontStyle: 'italic'}}>Please select any one</Text>
            }
                        ...
                        <View key={val}>
                            <TouchableOpacity  key={ele.answer_code} onPress={() => handle_option_press(ele.profile_question_id, ele.answer_code, val)}>
                                <View style={[styles.action, {backgroundColor: ele.is_answered ? '#378C3C' : '#ffffff'}]}>
                                    <Text style={{ fontSize: normalize(13), color: ele.is_answered ? '#ffffff' : '#000000'}}>{ele.description}</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                        )
                        ...
                        return (
                            <View key={val}>
                                <TouchableOpacity key={ele.answer_code} onPress={() => {
                                    ...
                                    <View style={[styles.action, {backgroundColor: ele.is_answered ? '#378C3C' : '#ffffff'}]}>
                                        <Text style={{ fontSize: normalize(8), color: ele.is_answered ? '#ffffff' : '#000000'}}>{ele.description}</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        )
