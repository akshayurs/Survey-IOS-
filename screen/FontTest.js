...
export default function fontTest({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={{ fontFamily: 'Academy Engraved LET' }}>
        Academy Engraved LET{' '}
      </Text>
      <Text style={{ fontFamily: 'AcademyEngravedLetPlain' }}>
      ...
      <Text style={{ fontFamily: 'AmericanTypewriter-Bold' }}>
        AmericanTypewriter-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'AmericanTypewriter-Condensed' }}>
        AmericanTypewriter-Condensed{' '}
      </Text>
      <Text style={{ fontFamily: 'AmericanTypewriter-CondensedBold' }}>
        AmericanTypewriter-CondensedBold{' '}
      </Text>
      <Text style={{ fontFamily: 'AmericanTypewriter-CondensedLight' }}>
        AmericanTypewriter-CondensedLight{' '}
      </Text>
      <Text style={{ fontFamily: 'AmericanTypewriter-Light' }}>
        AmericanTypewriter-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'Apple Color Emoji' }}>
        Apple Color Emoji{' '}
      </Text>
      <Text style={{ fontFamily: 'Apple SD Gothic Neo' }}>
        Apple SD Gothic Neo{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'AppleSDGothicNeo-Light' }}>
        AppleSDGothicNeo-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'AppleSDGothicNeo-Medium' }}>
        AppleSDGothicNeo-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'AppleSDGothicNeo-Regular' }}>
        AppleSDGothicNeo-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'AppleSDGothicNeo-SemiBold' }}>
        AppleSDGothicNeo-SemiBold{' '}
      </Text>
      <Text style={{ fontFamily: 'AppleSDGothicNeo-Thin' }}>
        AppleSDGothicNeo-Thin{' '}
      </Text>
      <Text style={{ fontFamily: 'AppleSDGothicNeo-UltraLight' }}>
        AppleSDGothicNeo-UltraLight{' '}
      </Text>
      <Text style={{ fontFamily: 'Arial' }}>Arial </Text>
      <Text style={{ fontFamily: 'Arial Hebrew' }}>Arial Hebrew </Text>
      <Text style={{ fontFamily: 'Arial Rounded MT Bold' }}>
        Arial Rounded MT Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'Arial-BoldItalicMT' }}>
        Arial-BoldItalicMT{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'AvenirNext-BoldItalic' }}>
        AvenirNext-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-DemiBold' }}>
        AvenirNext-DemiBold{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-DemiBoldItalic' }}>
        AvenirNext-DemiBoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-Heavy' }}>AvenirNext-Heavy </Text>
      <Text style={{ fontFamily: 'AvenirNext-HeavyItalic' }}>
        AvenirNext-HeavyItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-Italic' }}>
        AvenirNext-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-Medium' }}>
        AvenirNext-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-MediumItalic' }}>
        AvenirNext-MediumItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-Regular' }}>
        AvenirNext-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-UltraLight' }}>
        AvenirNext-UltraLight{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNext-UltraLightItalic' }}>
        AvenirNext-UltraLightItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-Bold' }}>
        AvenirNextCondensed-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-BoldItalic' }}>
        AvenirNextCondensed-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-DemiBold' }}>
        AvenirNextCondensed-DemiBold{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-DemiBoldItalic' }}>
        AvenirNextCondensed-DemiBoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-Heavy' }}>
        AvenirNextCondensed-Heavy{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-HeavyItalic' }}>
        AvenirNextCondensed-HeavyItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-Italic' }}>
        AvenirNextCondensed-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-Medium' }}>
        AvenirNextCondensed-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-MediumItalic' }}>
        AvenirNextCondensed-MediumItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-Regular' }}>
        AvenirNextCondensed-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-UltraLight' }}>
        AvenirNextCondensed-UltraLight{' '}
      </Text>
      <Text style={{ fontFamily: 'AvenirNextCondensed-UltraLightItalic' }}>
      ...
      <Text style={{ fontFamily: 'Baskerville-BoldItalic' }}>
        Baskerville-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'Baskerville-Italic' }}>
        Baskerville-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'Baskerville-SemiBold' }}>
        Baskerville-SemiBold{' '}
      </Text>
      <Text style={{ fontFamily: 'Baskerville-SemiBoldItalic' }}>
        Baskerville-SemiBoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'Bodoni 72' }}>Bodoni 72 </Text>
      <Text style={{ fontFamily: 'Bodoni 72 Oldstyle' }}>
        Bodoni 72 Oldstyle{' '}
      </Text>
      <Text style={{ fontFamily: 'Bodoni 72 Smallcaps' }}>
        Bodoni 72 Smallcaps{' '}
      </Text>
      <Text style={{ fontFamily: 'Bodoni Ornaments' }}>Bodoni Ornaments </Text>
      <Text style={{ fontFamily: 'BodoniOrnamentsITCTT' }}>
        BodoniOrnamentsITCTT{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoITCTT-Bold' }}>
        BodoniSvtyTwoITCTT-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoITCTT-Book' }}>
        BodoniSvtyTwoITCTT-Book{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoITCTT-BookIta' }}>
        BodoniSvtyTwoITCTT-BookIta{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoOSITCTT-Bold' }}>
        BodoniSvtyTwoOSITCTT-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoOSITCTT-Book' }}>
        BodoniSvtyTwoOSITCTT-Book{' '}
      </Text>
      <Text style={{ fontFamily: 'BodoniSvtyTwoSCITCTT-Book' }}>
        BodoniSvtyTwoSCITCTT-Book{' '}
      </Text>
      <Text style={{ fontFamily: 'Bradley Hand' }}>Bradley Hand </Text>
      <Text style={{ fontFamily: 'BradleyHandITCTT-Bold' }}>
        BradleyHandITCTT-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'Chalkboard SE' }}>Chalkboard SE </Text>
      <Text style={{ fontFamily: 'ChalkboardSE-Bold' }}>
        ChalkboardSE-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'ChalkboardSE-Light' }}>
        ChalkboardSE-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'ChalkboardSE-Regular' }}>
      ...
      <Text style={{ fontFamily: 'Cochin-BoldItalic' }}>
        Cochin-BoldItalic{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'Copperplate-Light' }}>
        Copperplate-Light{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'Courier-BoldOblique' }}>
        Courier-BoldOblique{' '}
      </Text>
      <Text style={{ fontFamily: 'Courier-Oblique' }}>Courier-Oblique </Text>
      <Text style={{ fontFamily: 'CourierNewPS-BoldItalicMT' }}>
        CourierNewPS-BoldItalicMT{' '}
      </Text>
      <Text style={{ fontFamily: 'CourierNewPS-BoldMT' }}>
        CourierNewPS-BoldMT{' '}
      </Text>
      <Text style={{ fontFamily: 'CourierNewPS-ItalicMT' }}>
      ...
      <Text style={{ fontFamily: 'Devanagari Sangam MN' }}>
        Devanagari Sangam MN{' '}
      </Text>
      <Text style={{ fontFamily: 'DevanagariSangamMN' }}>
        DevanagariSangamMN{' '}
      </Text>
      <Text style={{ fontFamily: 'DevanagariSangamMN-Bold' }}>
      ...
      <Text style={{ fontFamily: 'EuphemiaUCAS-Italic' }}>
        EuphemiaUCAS-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'Farah' }}>Farah </Text>
      <Text style={{ fontFamily: 'Futura' }}>Futura </Text>
      <Text style={{ fontFamily: 'Futura-CondensedExtraBold' }}>
        Futura-CondensedExtraBold{' '}
      </Text>
      <Text style={{ fontFamily: 'Futura-CondensedMedium' }}>
      ...
      <Text style={{ fontFamily: 'Georgia-BoldItalic' }}>
        Georgia-BoldItalic{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'GillSans-BoldItalic' }}>
        GillSans-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'GillSans-Italic' }}>GillSans-Italic </Text>
      <Text style={{ fontFamily: 'GillSans-Light' }}>GillSans-Light </Text>
      <Text style={{ fontFamily: 'GillSans-LightItalic' }}>
        GillSans-LightItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'GillSans-SemiBold' }}>
        GillSans-SemiBold{' '}
      </Text>
      <Text style={{ fontFamily: 'GillSans-SemiBoldItalic' }}>
        GillSans-SemiBoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'GillSans-UltraBold' }}>
        GillSans-UltraBold{' '}
      </Text>
      <Text style={{ fontFamily: 'Gujarati Sangam MN' }}>
        Gujarati Sangam MN{' '}
      </Text>
      <Text style={{ fontFamily: 'GujaratiSangamMN' }}>GujaratiSangamMN </Text>
      <Text style={{ fontFamily: 'GujaratiSangamMN-Bold' }}>
      ...
      <Text style={{ fontFamily: 'Helvetica-LightOblique' }}>
      ...
      <Text style={{ fontFamily: 'HelveticaNeue-BoldItalic' }}>
        HelveticaNeue-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-CondensedBlack' }}>
        HelveticaNeue-CondensedBlack{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-CondensedBold' }}>
        HelveticaNeue-CondensedBold{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-Italic' }}>
        HelveticaNeue-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-Light' }}>
        HelveticaNeue-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-LightItalic' }}>
        HelveticaNeue-LightItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-Medium' }}>
        HelveticaNeue-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-MediumItalic' }}>
        HelveticaNeue-MediumItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-Thin' }}>
        HelveticaNeue-Thin{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-ThinItalic' }}>
        HelveticaNeue-ThinItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-UltraLight' }}>
        HelveticaNeue-UltraLight{' '}
      </Text>
      <Text style={{ fontFamily: 'HelveticaNeue-UltraLightItalic' }}>
        HelveticaNeue-UltraLightItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'Hiragino Mincho ProN' }}>
      ...
      <Text style={{ fontFamily: 'HoeflerText-Black' }}>
        HoeflerText-Black{' '}
      </Text>
      <Text style={{ fontFamily: 'HoeflerText-BlackItalic' }}>
        HoeflerText-BlackItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'HoeflerText-Italic' }}>
        HoeflerText-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'HoeflerText-Regular' }}>
        HoeflerText-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'Iowan Old Style' }}>Iowan Old Style </Text>
      <Text style={{ fontFamily: 'IowanOldStyle-Bold' }}>
        IowanOldStyle-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'IowanOldStyle-BoldItalic' }}>
        IowanOldStyle-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'IowanOldStyle-Italic' }}>
      ...
      <Text style={{ fontFamily: 'Kannada Sangam MN' }}>
        Kannada Sangam MN{' '}
      </Text>
      <Text style={{ fontFamily: 'KannadaSangamMN' }}>KannadaSangamMN </Text>
      <Text style={{ fontFamily: 'KannadaSangamMN-Bold' }}>
        KannadaSangamMN-Bold{' '}
      </Text>
      <Text style={{ fontFamily: 'Khmer Sangam MN' }}>Khmer Sangam MN </Text>
      <Text style={{ fontFamily: 'Kohinoor Bangla' }}>Kohinoor Bangla </Text>
      <Text style={{ fontFamily: 'Kohinoor Devanagari' }}>
        Kohinoor Devanagari{' '}
      </Text>
      <Text style={{ fontFamily: 'Kohinoor Telugu' }}>Kohinoor Telugu </Text>
      <Text style={{ fontFamily: 'KohinoorBangla-Light' }}>
        KohinoorBangla-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorBangla-Regular' }}>
        KohinoorBangla-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorBangla-Semibold' }}>
        KohinoorBangla-Semibold{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorDevanagari-Light' }}>
        KohinoorDevanagari-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorDevanagari-Regular' }}>
        KohinoorDevanagari-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorDevanagari-Semibold' }}>
        KohinoorDevanagari-Semibold{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorTelugu-Light' }}>
        KohinoorTelugu-Light{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorTelugu-Medium' }}>
        KohinoorTelugu-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'KohinoorTelugu-Regular' }}>
        KohinoorTelugu-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'Lao Sangam MN' }}>Lao Sangam MN </Text>
      <Text style={{ fontFamily: 'Malayalam Sangam MN' }}>
        Malayalam Sangam MN{' '}
      </Text>
      <Text style={{ fontFamily: 'MalayalamSangamMN' }}>
        MalayalamSangamMN{' '}
      </Text>
      <Text style={{ fontFamily: 'MalayalamSangamMN-Bold' }}>
      ...
      <Text style={{ fontFamily: 'Optima-BoldItalic' }}>
        Optima-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'Optima-ExtraBlack' }}>
        Optima-ExtraBlack{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'Papyrus-Condensed' }}>
        Papyrus-Condensed{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'PingFangHK-Medium' }}>
        PingFangHK-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangHK-Regular' }}>
        PingFangHK-Regular{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangHK-Semibold' }}>
        PingFangHK-Semibold{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangHK-Thin' }}>PingFangHK-Thin </Text>
      <Text style={{ fontFamily: 'PingFangHK-Ultralight' }}>
      ...
      <Text style={{ fontFamily: 'PingFangSC-Semibold' }}>
        PingFangSC-Semibold{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangSC-Thin' }}>PingFangSC-Thin </Text>
      <Text style={{ fontFamily: 'PingFangSC-Ultralight' }}>
        PingFangSC-Ultralight{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangTC-Light' }}>PingFangTC-Light </Text>
      <Text style={{ fontFamily: 'PingFangTC-Medium' }}>
        PingFangTC-Medium{' '}
      </Text>
      <Text style={{ fontFamily: 'PingFangTC-Regular' }}>
        PingFangTC-Regular{' '}
      </Text>
      ...
      <Text style={{ fontFamily: 'TimesNewRomanPS-BoldItalicMT' }}>
        TimesNewRomanPS-BoldItalicMT{' '}
      </Text>
      <Text style={{ fontFamily: 'TimesNewRomanPS-BoldMT' }}>
        TimesNewRomanPS-BoldMT{' '}
      </Text>
      <Text style={{ fontFamily: 'TimesNewRomanPS-ItalicMT' }}>
        TimesNewRomanPS-ItalicMT{' '}
      </Text>
      <Text style={{ fontFamily: 'TimesNewRomanPSMT' }}>
        TimesNewRomanPSMT{' '}
      </Text>
      <Text style={{ fontFamily: 'Trebuchet MS' }}>Trebuchet MS </Text>
      <Text style={{ fontFamily: 'Trebuchet-BoldItalic' }}>
        Trebuchet-BoldItalic{' '}
      </Text>
      <Text style={{ fontFamily: 'TrebuchetMS-Bold' }}>TrebuchetMS-Bold </Text>
      <Text style={{ fontFamily: 'TrebuchetMS-Italic' }}>
        TrebuchetMS-Italic{' '}
      </Text>
      <Text style={{ fontFamily: 'Verdana' }}>Verdana </Text>
      <Text style={{ fontFamily: 'Verdana-Bold' }}>Verdana-Bold </Text>
      <Text style={{ fontFamily: 'Verdana-BoldItalic' }}>
        Verdana-BoldItalic{' '}
      </Text>
