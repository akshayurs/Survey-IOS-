...
export default function MyAccountScreen({ navigation }) {
  const { isLoading, logout, userInfo, login_to_update_profile_question } =
  ...
  return (
    ...
    >
        ...
        <View
          style={[
            styles.action,
            { backgroundColor: '#ffffff', justifyContent: 'space-around' },
          ]}
        >
          <View style={{ flex: 0.1 }}>
          ...
          >
            <View>
              <Text style={{ fontWeight: 'bold', fontSize: normalize(13) }}>
                Personal Details
              </Text>
              <Text style={{ fontStyle: 'italic', fontSize: normalize(10) }}>
        ...
        >
          ...
          >
            <View>
              ...
              <Text style={{ fontStyle: 'italic', fontSize: normalize(10) }}>
                prefered means of communications
              </Text>
            </View>
          </TouchableOpacity>
          <View style={{ flex: 0.1, alignItems: 'center', marginRight: 0 }}>
