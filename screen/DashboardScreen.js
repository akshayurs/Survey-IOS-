        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Image
              ...
              source={{
                uri: `${
                  userInfo && userInfo.Result && userInfo.Result.profilePic
                }`,
              }}
            />
          </View>
          ...
          {comments == undefined && (
            ...
            >
              <View>
                ...
                >
                  Watch out for survey notifications….
                </Text>
              </View>
            </View>
          )}
                ...
                <View style={styles.products} key={ele.survey_id}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Image
                          source={require('../assets/LOI.png')}
                          style={styles.product_sml_icon_1}
                        ></Image>
                        <Text style={styles.points_}>
                          {ele.survey_duration}
                          <Text
                            style={{
                              fontWeight: '400',
                      ...
                      >
                        <Image
                          source={require('../assets/reward_Gr.png')}
                          style={styles.product_sml_icon_2}
                        ></Image>
                        <Text style={styles.points_}>
                          {ele.survey_incentive}
                          <Text
                            style={{
                              fontWeight: '400',
                              fontSize: normalize(16),
