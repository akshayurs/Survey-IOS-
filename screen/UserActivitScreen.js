    ...
    return (
        <ScrollView showsVerticalScrollIndicator ={false}>
            <View style={styles.container}>
                ...
                <Text style={{color: '#378C3C', marginTop:10, textAlign: "center", fontSize:normalize(15), }}>Points History</Text>
                <Image
                ...
                <View style={[styles.products, {display:'flex', flexDirection:'row', justifyContent: 'space-between', backgroundColor: '#d4d6d1', marginTop: 10, paddingLeft: 6, paddingRight: 6}]}>
                    <Text style={[{flex: 0.25, color: '#000000', marginTop:10, textAlign: "center", fontSize:normalize(15), fontWeight: 'bold'}]}>Date</Text>
...
const styles = StyleSheet.create({
    table_row_data:{
        color: '#000000', marginTop:10, textAlign: "center", fontSize:normalize(13)
    },
    tabel_header: {
        color: '#000000', marginTop:10, textAlign: "center", fontSize:normalize(15), fontWeight: 'bold'
    },
    container: {
