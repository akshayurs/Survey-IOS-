    ...
    // if(link === null){
        ...
        <ScrollView showsVerticalScrollIndicator ={false} contentContainerStyle={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={{color: '#378C3C',marginTop:10, textAlign: "center", fontSize:normalize(15), }}>Spinner</Text>
                <Image
                        ...
                        if(val % 2 == 0){
                            ...
                            <TouchableOpacity style={styles.products} key={val} onPress={() => {handleNavigation(ele.Link)}}>
                                <View style={[styles.center_, {flex: 1.2}]}>
                                    <Text style={{textAlign: 'center', fontSize: 15, fontWeight: "500", padding: 10}}>{ele.Description}</Text>
                                </View>
